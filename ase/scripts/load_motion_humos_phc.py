...
motion_file = os.path.join("/home/hlz/datasets/humos_results/a_person_squats_and_rais_male_00c972db.pkl")
...
asset_file = os.path.join(project_dir, "data/assets/mjcf/smpl/00c972db_smpl.xml")
